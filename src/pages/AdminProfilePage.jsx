            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  <span className="px-2.5 py-0.5 rounded-full bg-red-500/10 text-red-600 text-[11px] font-bold uppercase tracking-wider border border-red-500/20">
                    {user.role}
                  </span>
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                  <h3 className="text-lg font-bold text-[#0A2E1A] mb-6 flex items-center gap-2">
                    <UserCircle size={20} className="text-[#5C8D73]" /> Admin Information
                  </h3>
                ...
                <div className="bg-[#092A1A] rounded-2xl p-8 shadow-lg text-white relative overflow-hidden">
                   ...
                   <div className="relative z-10">
                     <h3 className="text-lg font-bold mb-2 flex items-center gap-2 text-[#96D9C0]">
                       <Shield size={20} /> Administrative Security
                     </h3>
                     <p className="text-white/70 text-sm mb-6 max-w-md">You have full administrative access. All actions are logged for security purposes.</p>
                     <div className="flex flex-wrap gap-4">
                       <SecurityTag label="Admin Verified" />
                       <SecurityTag label="Full Access" />
                       <SecurityTag label="Encrypted Session" />
                     </div>
                   </div>
                </div>
              </div>
